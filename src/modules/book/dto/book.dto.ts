...
export class CreateBookDto {
    ...
    @MinLength(3, {
        message: i18nValidationMessage(
            'validation.VALIDATION_TITLE_MIN_LENGTH',
        ),
    })
    @MaxLength(255, {
        message: i18nValidationMessage(
            'validation.VALIDATION_TITLE_MAX_LENGTH',
        ),
    })
    title: string;
    ...
    @MinLength(3, {
        message: i18nValidationMessage(
            'validation.VALIDATION_AUTHOR_MIN_LENGTH',
        ),
    })
    @MaxLength(255, {
        message: i18nValidationMessage(
            'validation.VALIDATION_AUTHOR_MAX_LENGTH',
        ),
    })
    author: string;
