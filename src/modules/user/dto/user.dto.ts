...
export class SignUpDto {
  @IsString({
    message: i18nValidationMessage('validation.VALIDATION_FIRST_NAME_STRING'),
  })
  @IsNotEmpty({
    message: i18nValidationMessage('validation.VALIDATION_FIRST_NAME_STRING'),
  })
  ...
  @IsOptional()
  @IsString({
    message: i18nValidationMessage('validation.VALIDATION_LAST_NAME_STRING'),
  })
  @MinLength(2, {
    message: i18nValidationMessage(
  ...
  @IsNotEmpty({
    message: i18nValidationMessage('validation.VALIDATION_PASSWORD_REQUIRED'),
  })
  password: string;
}
...
export class SetUsernameDto {
  ...
  @MinLength(5, {
    message: i18nValidationMessage('validation.VALIDATION_USERNAME_MIN_LENGTH'),
  })
  @MaxLength(20, {
    message: i18nValidationMessage('validation.VALIDATION_USERNAME_MAX_LENGTH'),
  })
  username: string;
}
